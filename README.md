...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ed2m65w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ed2m65w.containers.anotherwebservice.com/
...
```
git clone git@github.com:axelmedjber/container-ed2m65w.git
cd container-ed2m65w
```
...
```
docker attach container-ed2m65w
```
